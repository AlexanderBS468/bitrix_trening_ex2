...
<p>
	<b>ex2-11 Оценить скорость работы сайта – найти самую долгую страницу и количество
		запросов </b>
<p>Самая, загрузка которой занимает больше времени = <b>/ex2/simplecomp_97/index.php</b></p>
<p>Ёе долю % = <b>10.91%</b></p>
<p>Страница-время(сред) = <b>0.0830 сек.</b></p>
<table border="1" cellpadding="0" cellspacing="0" border="0" width="100%">
	<tbody>
	<thead>
	<tr>
